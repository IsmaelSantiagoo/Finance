  ...
  return (
    <Container className="flex flex-col gap-3 w-[40rem] p-2">
      <div className="flex flex-col gap-3">
        ...
        <p className="text-center">Deletar esse dado fará com que você o perca o histórico porém o valor não será estornado para o seu cartão automaticamente! Para isso você deve realizar um estorno!</p>
      </div>
